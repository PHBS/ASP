...
__04__ | 3.19 Fri | [Numpy crach course](py/PythonCrashCourse_Numpy.ipynb). Black-Scholes implementation ([Py Demo](py/BlackScholes_FunctionVsClass.ipynb)). Normal model ([Slides](files/Normal_Model.pdf)), Black-Scholes-Merton and Normal option pricing with MC ([Py Demo](py/BlackScholes_MC.ipynb))
__05__ | 3.23 Tue | Implied volatility ([Slides](files/ImpVol.pdf), [Py demo](py/BlackScholes_ImpliedVol.ipynb)). Spread/Basket options ([Slides](files/SpreadBasketOption.pdf)), Correlated Normal RNs ([Slides](files/MCmethod.pdf) \| [Py Demo](py/CorrelatedNormals_Demo.ipynb))
