...
__11__ | 10.03 Mon | SV Model Simulation for Project ([Slides](files/SV_Simulation.pdf)), [Past Exams](files/ASP_Problems.pdf) Review
__12__ | 10.06 Thurs | [Past Exams](files/ASP_Problems.pdf) Review
__13__ | 10.10 __Wed__ | Midterm Exam ([Solution](files/ASP2020_Midterm.pdf))
__14__ | 10.13 Thurs | Copula ([Slides](files/Copula.pdf), [Py demo](py/Demo_Copula.ipynb))
__15__ | 10.17 Mon | Copula ([Slides](files/Copula.pdf), [Py demo](py/Demo_Copula.ipynb))
__16__ | 10.20 Wed | Research Presentation: NSVh model and Normal SABR ([Slides](files/NSVh_Slides.pdf))
__17__ | 10.24 Mon | Course project presentation
...
* ### __Set 1__ [Due by 9.10] Generate a function for generating standard normal RN following Problem 2 of 2021.M3 midterm exam. After drawing 1e6 RNs, check if they are truly standard normal RNs.
